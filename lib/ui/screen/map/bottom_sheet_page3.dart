...
import 'package:cafejari_flutter/ui/screen/map/component/bottom_sheet_floor_deco.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child:ActionButtonPrimary(buttonWidth: 210, buttonHeight: 40, title: "등록하기", onPressed: () => {}, primaryColor: true,) ,
          )
        ],
      ),
    );
