...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(userId: $userId, profileId: $profileId, isAdmin: $isAdmin, dateJoined: $dateJoined, lastLogin: $lastLogin, fcmToken: $fcmToken, phoneNumber: $phoneNumber, imageUrl: $imageUrl, point: $point, grade: $grade, activitySeconds: $activitySeconds)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.activitySeconds, activitySeconds) ||
                other.activitySeconds == activitySeconds));
  }
